...
@section('content')
    <div class="container-fluid">
        <!-- 1st section -->
        <div class="row row-cols-2" style="background-color: #EBF0F2; padding: 3%">
            <div class="col-lg-6 col-xlg-6 col-md-6 col-12 d-flex align-items-center justify-content-center" style="padding: 2%">
                <div class="row" style="">
                    <div class="col-12">
                        <div class="">
                            <h3>اختبارات قياس لميول الأشخاص</h3>
                            <p class="fs-5">
                                اكتشف نفسك أكثر وتعرّف على سسماتك الشخصية ونقاط قوتك وضعفك لتصبح أفضل،
                                أنت على بُعد خطوة من رحلة اكتشاف ذاتك، ميولك، تخصصك الجامعي المناسب
                            </p>

                            <div class="row row-cols-2">
                                <div class="col">
                                    <button class="btn read-more" type="submit">اقرأ المزيد</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="">
                            <div class="row row-cols-2">
                                <div class="col-auto">
                                    <p>تابعنا على شبكاتنا الاجتماعية</p>
                                </div>
                                <div class="col-auto">
            ...
            <div class="col-lg-6 col-xlg-6 col-md-6 col-12 text-center d-flex align-items-center justify-content-center" style="padding: 2%">
                <img src="https://image-dall.fra1.digitaloceanspaces.com/static_images/images/images/Picture1.png" style="width: 60%">
            </div>
        </div>

        <!-- who are we section -->
        <div class="row row-cols-2" id="who" style=" padding: 3% 3% 3% 0">
                ...
                <div class="row" style="">
                    <div class="col-12">
                        ...
                        <div class="" style="padding-top: 1%">
                            <h3 class="fw-bold">من نحــن</h3>
                            <p class="fs-5">
                                بوابة لمساعدة الأفراد على تحديد مسسارهم التعليمي والوظيفي الأفضل لهم ويتناسب مع
                                قدراتهم من خلال قياس نتائج اختبارات علمية دقيقة لتحديد واكتشاف ورسم خارطة مسستقبل
                                تتناسب معهم وقابلة للتطور
                            </p>
                            ...
                            <div class="row row-cols-2">
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <p>توجيه القدرات البشرية في مكانها</p>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="row row-cols-2">
                                    ...
                                    <div class="row">
                                        <p>المرجع الرقمي الأول بالشرق الأوسط لقياسس قدرات الأفراد</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <ol>
                                            <li>استخدام أدوات الذكاء الاصطناعي لتحيل نتائج الاختبارات</li>
                                            <li>اسستخدام أول مقياس عربي لقياس قدرات الأفراد من خلال خوارزميات رياضية</li>
                                            <li>قاعدة بيانات مركزية لربط وتحليل البيانات الذكية للنتائج</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- tests section -->
        <div class="row row-cols-2" id="test" style="background-color: #EBF0F2; padding: 3%">
            <div class="col-12" style="padding: 2%">
                <div class="row" style="">
                    <div class="col-12">
                        <div style="width: 30px; height: 4px; background-color: #E99424"></div>
                        <div class="" style="padding-top: 1%">
                            <h3 class="fw-bold">الاختبــارات</h3>
                            ...
                            <div class="row">
                              ...
                              border-top-right-radius: 20px;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">يسـاعدك هذا الاختبار من خلال مجموعة من الأسئلة الدقيقة في التعرف</p>
                                                    <button type="button" class="btn test-price">200 ريال سعودي</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="card" style="border-radius: 20px">
                                                ...
                                                <div class="card-body">
                                                    <a class="text-reset" href="{{url('testDetails')}}">
                                                        <h5 class="card-title">اختبـار المهارات والميول</h5>
                                                    </a>
                                                    <p class="card-text">احصر خيـاراتك وتعرّف على أكثر ما يلائم شغفـك وميولك، من خلال مجموعة من الأسئلة غير المباشرة</p>
                                                    <button type="button" class="btn test-price">250 ريال سعودي</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="card" style="border-radius: 20px">
                                                ...
                                                <div class="card-body">
                                                    <a class="text-reset" href="{{url('testDetails')}}">
                                                        <h5 class="card-title">اختبـار القدرات الذهنية</h5>
                                                    </a>
                                                    <p class="card-text">تعرّف على مدى تركيزك، حفظك، استرجاعك للمعلومات، دقة ملاحظاتـك، ومهاراتك الرياضية والتحليلية</p>
                                                    <button type="button" class="btn test-price">300 ريال سعودي</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="card" style="border-radius: 20px">
                                                ...
                                                <div class="card-body">
                                                    <a class="text-reset" href="{{url('testDetails')}}"><h5 class="card-title">اختبـار تحليل الشخصية</h5></a>
                                                    <p class="card-text">يسـاعدك هذا الاختبار من خلال مجموعة من الأسئلة الدقيقة في التعرف</p>
                                                    <button type="button" class="btn test-price">220 ريال سعودي</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="card" style="border-radius: 20px">
                                                ...
                                                <div class="card-body">
                                                    <a class="text-reset" href="{{url('testDetails')}}"><h5 class="card-title">اختبـار تحليل الشخصية</h5></a>
                                                    <p class="card-text">يسـاعدك هذا الاختبار من خلال مجموعة من الأسئلة الدقيقة في التعرف</p>
                                                    <button type="button" class="btn test-price">280 ريال سعودي</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="card" style="border-radius: 20px">
                                                ...
                                                <div class="card-body">
                                                    <a class="text-reset" href="{{url('testDetails')}}"><h5 class="card-title">اختبـار تحليل الشخصية</h5></a>
                                                    <p class="card-text">يسـاعدك هذا الاختبار من خلال مجموعة من الأسئلة الدقيقة في التعرف</p>
                                                    <button type="button" class="btn test-price">240 ريال سعودي</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col text-center" style="padding-top: 2%; ">
                                    <a type="button" class="btn view-more" href="all-tests.html"><i class='fas fa-plus'></i>&nbsp; &nbsp; إظهـار المزيـد </a>
                                </div>
                            </div>
        ...
        <!-- populer questions section -->
        <div class="row row-cols-2" id="question" style=" padding: 3% 3% 3% 0">
            <div class="col-lg-6 col-xlg-6 col-md-6 col-12" style="padding: 2%">
                <div class="row" style="">
                    <div class="col-12">
                        <div style="width: 30px; height: 4px; background-color: #E99424; "></div>
                        <div class="" style="padding-top: 1%">
                            <h3 class="fw-bold">الأسئلــة الشـائعة</h3>

                            <div class="row" style="padding-top: 4%">
                                <div class="col-12" style="padding-bottom: 2%">
                                    <div id="accordion">
                                        <div class="card" style="border-top-left-radius: 15px; border-top-right-radius: 15px; border-right-color: #E99424; border-right-width: 5px">
                                            <div class="card-header" id="headingOne" style="background-color: white; border-bottom: none; border-top-left-radius: 15px; border-top-right-radius: 15px">
                                                <h5 class="mb-0">
                                                    <button class="btn" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        <span class=""><dt>كيف أحصل على أدق نتيجة من الاختبار؟</dt></span>
                                                    </button>
                                                </h5>
                                            </div>

                                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion" style="border-top: none">
                                                <div class="card-body">
                                                    حصولك على أدق النتائج هو أمر متوقف لديك! اتبع النصائح التالية والنصائح الخاصة بكل اختبار
                                                    لتحصل على النتيجة الصحيحة ولا تنسى إكمال أقسام الاختبار الثلاثة لتحصل على التقرير المفصل.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-header" id="headingOne" style="background-color: white; border-bottom: none; border-top-left-radius: 15px; border-top-right-radius: 15px">
                                                <h5 class="mb-0">
                                                    <button class="btn" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseOne">
                                                        <span class=""><dt>ما هي أكثر التخصصات الجامعية التي تناسب مهاراتي الشخصية؟</dt></span>
                                                    </button>
                                                </h5>
                                            </div>

                                            <div id="collapseTwo" class="collapse" aria-labelledby="headingOne" data-parent="#accordion" style="border-top: none">
                                                <div class="card-body">
                                                    حصولك على أدق النتائج هو أمر متوقف لديك! اتبع النصائح التالية والنصائح الخاصة بكل اختبار
                                                    لتحصل على النتيجة الصحيحة ولا تنسى إكمال أقسام الاختبار الثلاثة لتحصل على التقرير المفصل.
                                                </div>
                                            ...
                                            <div class="card-header" id="headingOne" style="background-color: white; border-bottom: none; border-top-left-radius: 15px; border-top-right-radius: 15px">
                                                <h5 class="mb-0">
                                                    <button class="btn" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseOne">
                                                        <span class=""><dt>ما نوع الامتحانات التي تقدمها منصة بيجيننج؟</dt></span>
                                                    </button>
                                                </h5>
                                            </div>

                                            <div id="collapseThree" class="collapse" aria-labelledby="headingOne" data-parent="#accordion" style="border-top: none">
                                                <div class="card-body">
                                                    حصولك على أدق النتائج هو أمر متوقف لديك! اتبع النصائح التالية والنصائح الخاصة بكل اختبار
                                                    لتحصل على النتيجة الصحيحة ولا تنسى إكمال أقسام الاختبار الثلاثة لتحصل على التقرير المفصل.
                                                </div>
                                ...
                                <div class="col-12" style="padding-bottom: 2%">
                                    <div id="accordion">
                                        <div class="card" style="border-top-left-radius: 15px; border-top-right-radius: 15px; border-right-color: #E99424; border-right-width: 5px">
                                            ...
                                            <div id="collapseFour" class="collapse" aria-labelledby="headingOne" data-parent="#accordion" style="border-top: none">
                                                <div class="card-body">
                                                    حصولك على أدق النتائج هو أمر متوقف لديك! اتبع النصائح التالية والنصائح الخاصة بكل اختبار
                                                    لتحصل على النتيجة الصحيحة ولا تنسى إكمال أقسام الاختبار الثلاثة لتحصل على التقرير المفصل.
                                                </div>
                                ...
                                <div class="col-12" style="padding-bottom: 2%">
                                    <div id="accordion">
                                        <div class="card" style="border-top-left-radius: 15px; border-top-right-radius: 15px; border-right-color: #E99424; border-right-width: 5px">
                                            <div class="card-header" id="headingOne" style="background-color: white; border-bottom: none; border-top-left-radius: 15px; border-top-right-radius: 15px">
                                                <h5 class="mb-0">
                                                    <button class="btn" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseOne">
                                                        <span class=""><dt>ما هي أكثر التخصصات الجامعية التي تناسب مهاراتي الشخصية؟</dt></span>
                                                    </button>
                                                </h5>
                                            </div>

                                            <div id="collapseFive" class="collapse" aria-labelledby="headingOne" data-parent="#accordion" style="border-top: none">
                                                <div class="card-body">
                                                    حصولك على أدق النتائج هو أمر متوقف لديك! اتبع النصائح التالية والنصائح الخاصة بكل اختبار
                                                    لتحصل على النتيجة الصحيحة ولا تنسى إكمال أقسام الاختبار الثلاثة لتحصل على التقرير المفصل.
                                                </div>
        ...
        <div class="row row-cols-2" id="about-us" style="background-color: #EBF0F2; padding: 3%">
            <div class="col-12" style="padding: 2%">
                <div class="row" style="">
                    <div class="col-12">
                        <div style="width: 30px; height: 4px; background-color: #E99424"></div>
                        <div class="" style="padding-top: 1%">
                            <h3 class="fw-bold">مـاذا قـالوا عنـا</h3>
                            <p class="fs-5">
                                هنا تجد بعض من أرآء عملائنا الكـرام وملاحظاتهم، وهنـاك الكثير...
                            </p>
                                    ...
                                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <div class="row row-cols-1 row-cols-md-3 g-4" style="padding-right: 3%; padding-left: 3%">
                                                    <div class="col">
                                                        <div class="card" style="border-radius: 20px">
                                                            ...
                                                            <div class="card-body">
                                                                <p class="card-text">إنه موقع رائع ومميز جداً، موقع بيجنينج من أفضل المواقع
                                                                    التي تساعد الطلاب في اختيار تخصصهم المستقبلي
                                                                    بعناية من خلال مجموعة من الأسئلة الدقيقة والمدروسة جيداً.
                                                                </p>
                                                                <div class="row row-cols-2">
                                                                    <div class="col-auto">
                                                                    ...
                                                                    <div class="col-auto d-flex align-items-center justify-content-center">
                                                                        <p>
                                                                            <span class="fs-5">عبدالرحمن أحمد</span>
                                                                            <br>
                                                                            طالب جـامعي
                                                                        </p>
                                                                    </div>
                                                        ...
                                                        <div class="card" style="border-radius: 20px">
                                                            ...
                                                            <div class="card-body">
                                                                <p class="card-text">أنصح جميع الطلاب اللذين أنهوا المرحلة الثانوية بنجاح، ويريدوا
                                                                    الالتحاق بالجامعة، بتجربة موقع بيجينج، إنه موقع رائع، ويوجد فيه العديد
                                                                    من الاختبارات التي تساعد الطلاب في اختيارهم.
                                                                </p>
                                                                <div class="row row-cols-2">
                                                                    <div class="col-auto">
                                                                        <div class="d-flex align-items-center justify-content-center" style="background-color: lightgray; width: 90px; height: 90px; border-radius: 50%">
                                                                    ...
                                                                    <div class="col-auto d-flex align-items-center justify-content-center">
                                                                        <p>
                                                                            <span class="fs-5">محمد عبدالله</span>
                                                                            <br>
                                                                            طالب جـامعي
                                                                        </p>
                                                                    </div>
                                                        ...
                                                        <div class="card" style="border-radius: 20px">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row row-cols-2">
                                                                    ...
                                                                    <div class="col-auto d-flex align-items-center justify-content-center">
                                                                        <p>
                                                                            <span class="fs-5">عبدالرحيم المطيري</span>
                                                                            <br>
                                                                            طالب جـامعي
                                                                        </p>
                                                                    </div>
                                        ...
                                        <div class="row row-cols-2" style="padding-top: 5%; padding-left: 50%; padding-right: 50%">
                                            <div class="col text-start">
                                                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next" style="position: absolute; top: 90%;">
                                                    <i class="fa fa-chevron-circle-left" style="font-size:48px; color:#0B3E61"></i>
                                                    <span class="visually-hidden">Next</span>
                                                </button>
                                            </div>
                                            <div class="col text-end">
                                                <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev" style="position: absolute; top: 90%;">
                                                    <i class="fa fa-chevron-circle-right" style="font-size:48px; color:#0B3E61"></i>
        ...
        <!-- contact us section -->
        <div class="row row-cols-2" id="contact-us" style=" padding: 3% 3% 3% 0">
            <div class="col-lg-6 col-xlg-6 col-md-6 col-12" style="padding: 2%">
                <div class="row" style="">
                    <div class="col-12">
                        <div style="width: 30px; height: 4px; background-color: #E99424"></div>
                        <div class="" style="padding-top: 1%">
                            <h3 class="fw-bold">تواصـل معنـا</h3>

                            <div class="row" style="padding-top: 3%">
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">الاسم كاملاً</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="مثال: محمد أحمد محمود عبدالله">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">البريد اللكترونيً</label>
                                        <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="مثال: example123@gmail.com">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">عنوان الرسالة</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="مثال: استفسار عن اختبار ما">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">الرسالة</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="اكتب نص رسالتك هنا ..."></textarea>
                                    </div>
                                    <div class="mb-3 text-start">
                                        <button type="button" class="btn send-msg">إرسـال</button>
                                    </div>
                                </div>
                            </div>
